...
const Recom = () => {
    const img9 = "/src/components/Products/img/";
  return (
    <section className="recom">
    <div className="container">
    <h2 className='recom__text'>мы рекомендуем</h2>
        <div className="recom__content">
            
            <div className="recom__item">
                <div className="recom__top">
                    <img className="recom__img" src={img9 + "item.png"} alt="" />
                    <div className="recom__icon">
                        <svg className="recom__favorite" width="30" height="27" viewBox="0 0 30 27" fill="none"
                        ...
                        <svg className="recom__favorite--animate" width="30" height="27" viewBox="0 0 30 27" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="recom__bottom">
                    <h2 className="recom__name">Медный чайник с фарфоровой ручкой</h2>
                    <h3 className="recom__price">1 953 грн</h3>
                </div>
            </div>
            <div className="recom__item item">
                <div className="recom__top">
                    <img className="recom__img" src={img9 + "item.png"} alt="" />
                    <div className="recom__icon">
                        <svg className="recom__favorite" width="30" height="27" viewBox="0 0 30 27" fill="none"
        ...
        <div className="recom__button">
            <button className='button__recom recom'>Перейти в каталог</button>
        </div>
    </div>
</section>
  )
