...
const present = () => {
    const img7 = "/src/components/Products/img/";
  return (
    <section className="present">
    <div className="container">
    <h2 className='present__text'>ЛУЧШИЕ ПРОДАЖИ</h2>
        <div className="present__content">
            
            <div className="present__item">
                <div className="present__top">
                    <img className="present__img" src={img7 + "item.png"} alt="" />
                    <div className="present__icon">
                        <svg className="present__favorite" width="30" height="27" viewBox="0 0 30 27" fill="none"
                        ...
                        <svg className="present__favorite--animate" width="30" height="27" viewBox="0 0 30 27" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="present__bottom">
                    <h2 className="present__name">Медный чайник с фарфоровой ручкой</h2>
                    <h3 className="present__price">1 953 грн</h3>
                </div>
            </div>
            <div className="present__item item">
                <div className="present__top">
                    <img className="present__img" src={img7 + "item.png"} alt="" />
                    <div className="present__icon">
                        <svg className="present__favorite" width="30" height="27" viewBox="0 0 30 27" fill="none"
        ...
        <div className="present__button">
            <button className='button__present prese'>Перейти в каталог</button>
        </div>
    </div>
</section>
  )
